...
export type CodePanelMode = 'numeric' | 'alpha';
...
export interface Puzzles {
  bookshelf_lock: PuzzleHints;
  typewriter_lock: PuzzleHints;
  tower_exit: PuzzleHints;
}
...
export type ItemId = 'babel_key' | 'grammar_fragment' | 'tower_key' | 'translation_lens';
...
export interface GameEvents {
  ...
  closeDialog: () => void;
  showCodePanel: (title: string, subtitle: string, mode: CodePanelMode) => void;
